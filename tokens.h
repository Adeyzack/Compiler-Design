...
enum Tokens {ADDOP = 256, MULOP, ANDOP, RELOP, ARROW, BEGIN_, CASE, CHARACTER, END,
     ...
     IDENTIFIER, INT_LITERAL, CHAR_LITERAL, ELSE, ELSIF, ENDFOLD, ENDIF, FOLD, IF, LEFT, REAL, RIGHT, THEN, OROP, NOTOP,  REMOP, EXPOP, NEGOP, INTEGER_LITERAL, REAL_LITERAL, CHARACTER_LITERAL};
